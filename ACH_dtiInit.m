function [dt6FileName, outBaseDir] = ACH_dtiInit(dwRawFileName, t1FileName, dwParams)
...
if computeB0, dtiRawComputeMeanB5(dwRaw, bvals, dwDir.mnB0Name, doAlign); end
...
switch lower(dwParams.fitMethod)
    case {'ls'}
        dt6FileName{1} = ACH_dtiRawFitTensorMex(dwRawAligned, dwDir.alignedBvecsFile,...
