function [fh, figurename] = SO_dtiCheckMotion(ecXformFile,visibility)
...
printCommand = ...
    ...
    num2str(lower(fh.Name)),figurename); % changed fh to fh.Name 
fprintf('[%s] Saving Eddy Current correction figure: \n %s \n', ...
         mfilename,figurename);
eval(printCommand);
print(fh, '-painters','-dpng', '-noui', '/home/ganka/git/AMD.png')
