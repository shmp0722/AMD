function AMD_AFQ_plotIndividual
...
outdir = '/home/ganka/git/AMD/afq/AFQ_plot';
...
%     set(gca, 'XTickLabelRotation',90,'XLim',[0,nfg])

%     set(gca,'xtick',1:nfg,'xticklabel',newfgNames,'xlim',[0 nfg+1],'fontname','times','fontsize',11);
%     set(gca,'xtick',1:nfg,'xticklabel',fgNames,'xlim',[0 nfg+1],'fontname','times','fontsize',11);

    set(gca,'XTickLabel',[],'xtickd', 'out' ,'XLim',[0,nfg])
    ylabel(upper(valtitle{v}));
   
end

legend(afq.fgnames{1:20});
legend off
return
